            ...
            <div class="about-info">
                <div class="about-header">
                    ...
                    <span class="availability-badge">
                        ...
                        ${window.i18n.t('commands.about.availability')}
                    </span>
                </div>
                ...
                <div class="about-details">
                    <div class="about-detail-item">
                        ...
                        <span class="detail-label">${window.i18n.t('commands.about.age')}</span>
                        <span class="detail-value">${age} ${window.i18n.t('commands.about.years')}</span>
                    </div>
                    <div class="about-detail-item">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                        <span class="detail-label">${window.i18n.t('commands.about.location')}</span>
                    ...
                    <div class="about-detail-item">
                        ...
                        <span class="detail-label">${window.i18n.t('commands.about.role')}</span>
                        <span class="detail-value">Full-stack · Mobile Developer</span>
                    </div>
                </div>

                <h3 class="about-subtitle">${window.i18n.t('commands.about.story')}</h3>
                <p class="about-text">${window.i18n.t('commands.about.story1')}</p>
                <p class="about-text">${window.i18n.t('commands.about.story2')}</p>
                <p class="about-text">${window.i18n.t('commands.about.story3')}</p>

                <h3 class="about-subtitle">${window.i18n.t('commands.about.traits')}</h3>
                <ul class="about-traits">
                    <li>
                        ...
                        <span>${window.i18n.t('commands.about.trait1')}</span>
                    </li>
                    <li>
                        <span class="trait-icon" aria-hidden="true">
                        ...
                        <span>${window.i18n.t('commands.about.trait2')}</span>
                    </li>
                    <li>
                        <span class="trait-icon" aria-hidden="true">
                        ...
                        <span>${window.i18n.t('commands.about.trait3')}</span>
                    </li>
                    <li>
                        <span class="trait-icon" aria-hidden="true">
                        ...
                        <span>${window.i18n.t('commands.about.trait4')}</span>
                    </li>
                </ul>

                <h3 class="about-subtitle">${window.i18n.t('commands.about.beyond')}</h3>
                <p class="about-text">${window.i18n.t('commands.about.beyondText')}</p>

                <h3 class="about-subtitle">${window.i18n.t('commands.about.contact')}</h3>
